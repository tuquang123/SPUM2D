...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      /*private void ShowWheelPieces()
      {
         for (int i = 0; i < m_listItemDefine.Count; i++)
         {
            wheelPieces[i].Icon = m_listItemDefine[i].sprite;
            wheelPieces[i].Label = m_listItemDefine[i].name;
